...
**Python | SQL | Power BI | Data Cleaning & Segmentation**  
- Processed +4M rows of trip data.  
- Segmented users and identified behavioral patterns.  
- Designed an interactive Power BI dashboard with KPIs for retention and usage trends.  
...
- Explored user health patterns from wearable device data.  
- Built visualizations to support product and marketing decisions.  
👉 *Repository link coming soon*
